...
class SparseKTConfig:
    ...
    out_dir: str = "runs/sparsekt_v8"


def run_sparsekt(cfg: SparseKTConfig) -> dict:
    ...
    return train_eval_kt(
        ...
        encoding_note="SparseKT: top-k sparse cross-attention readout over history",
    )
