...
This repository ships **precomputed student split lists** under `data/splits/` (F19 and S19, seeds 0–9). It does **not** ship raw CSEDM files, processed framework logs, LLM caches, or model checkpoints.
